        ...
        <div className="relative w-full min-h-screen bg-[#030014] text-white overflow-hidden font-sans">
            ...
            <main className="relative z-10 pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto flex flex-col items-center space-y-20">
                ...
                <motion.section
                    ...
                    variants={fadeIn}
                >
                    <h1 className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-linear-to-r from-white via-purple-200 to-purple-400 drop-shadow-lg">
                        Who We Are
                    </h1>
                    <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">
                        We are a dedicated team of creative professionals committed to building brands that stand out in the digital space. Our expertise spans web development, marketing, and design, ensuring your brand reaches its full potential.
                    </p>
                </motion.section>
                        ...
                        {[1, 2, 3].map((item, index) => (
                            <GlassCard key={index}>
                                <div className="flex flex-col items-center text-center space-y-4">
                                    <div className="w-20 h-20 rounded-full bg-linear-to-tr from-purple-400 to-blue-500 p-[2px]">
                                        <div className="w-full h-full rounded-full bg-[#0a0a0a] flex items-center justify-center overflow-hidden">
                                            <User className="text-white/50 w-10 h-10" />
                                        </div>
                                    </div>
                                    <p className="text-gray-300 italic">"The team transformed our online presence and delivered outstanding results. Highly recommended!"</p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-8 p-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl h-full">
                            <div>
                                ...
                                <p className="text-gray-400">Have a project in mind? We'd love to hear from you.</p>
                            </div>
                        ...
                        <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl relative overflow-hidden">
                            ...
                            <h3 className="text-2xl font-bold text-white mb-6 text-center">Let's Work Together</h3>
