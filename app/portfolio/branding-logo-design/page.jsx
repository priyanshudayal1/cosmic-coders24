...
export default function BrandingLogoDesignPortfolio() {
    const projects = [
        ...
        },
        {
            ...
            description: "Sustainable packaging design with unboxing experience focus.",
            deliverables: ["Box Design", "Tissue Paper", "Stickers"],
            image: "📦"
        },
        {
            title: "Fitness Brand Identity",
            description: "Athletic brand with bold typography and energetic color palette.",
                            ...
                            {projects.map((project, index) => (
                                <SpotlightCard key={index} className="h-full flex flex-col">
                                    ...
                                    <div className="space-y-2 mb-4">
                                        <div className="text-sm text-gray-500 font-semibold">Deliverables:</div>
