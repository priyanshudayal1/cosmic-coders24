...
export default function WebsiteDevelopmentPortfolio() {
    const projects = [
        ...
        },
        {
            ...
            description: "Analytics dashboard for business intelligence with real-time data visualization.",
            tech: ["React", "D3.js", "Node.js", "PostgreSQL"],
            image: "📊"
        },
        {
            title: "Corporate Website",
            description: "Professional corporate presence with CMS integration and multilingual support.",
