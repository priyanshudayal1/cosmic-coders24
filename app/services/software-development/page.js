            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <SectionHeading
                        ...
                        title={<span className="whitespace-nowrap text-3xl md:text-4xl lg:text-5xl">Custom Software That Automates, Scales & Simplifies Your Business</span>}
                    ...
                    <div className="flex justify-center">
                        <div className="relative w-32 h-32">
                            ...
                            <Settings className="w-full h-full text-purple-400/80 relative z-10 animate-spin-slow" strokeWidth={0.5} />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <SpotlightCard className="h-full bg-white/5 border-white/10 p-6 flex items-center gap-4 group hover:bg-white/10 transition-all duration-300">
                            ...
                            <h3 className="text-lg font-semibold text-white">Billing & Invoicing Software</h3>
                        </SpotlightCard>
                        ...
                        <SpotlightCard className="h-full bg-white/5 border-white/10 p-6 flex items-center gap-4 group hover:bg-white/10 transition-all duration-300">
                            ...
                            <h3 className="text-lg font-semibold text-white">Inventory & Stock Management</h3>
                        </SpotlightCard>
                        ...
                        <SpotlightCard className="h-full bg-white/5 border-white/10 p-6 flex items-center gap-4 group hover:bg-white/10 transition-all duration-300">
                            ...
                            <h3 className="text-lg font-semibold text-white">Project Management Tools</h3>
                        </SpotlightCard>
                        ...
                        <SpotlightCard className="h-full bg-white/5 border-white/10 p-6 flex items-center gap-4 group hover:bg-white/10 transition-all duration-300">
                            ...
                            <h3 className="text-lg font-semibold text-white">HR & Payroll Systems</h3>
                        </SpotlightCard>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <SpotlightCard className="h-full bg-white/5 border-white/10 group hover:bg-white/10 transition-colors duration-300">
                            <div className="flex flex-col h-full p-6">
                                ...
                                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-purple-200 transition-colors duration-300">Tailored for your business process</h3>
                                <p className="text-gray-400 text-sm leading-relaxed grow group-hover:text-gray-300 transition-colors duration-300">
                                    Built to fit your unique workflows perfectly, eliminating unnecessary features and complexity found in generic software.
                                </p>
                            </div>
                        </SpotlightCard>
                        ...
                        <SpotlightCard className="h-full bg-white/5 border-white/10 group hover:bg-white/10 transition-colors duration-300">
                            <div className="flex flex-col h-full p-6">
                                ...
                                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-purple-200 transition-colors duration-300">Scalable & future-ready</h3>
                                <p className="text-gray-400 text-sm leading-relaxed grow group-hover:text-gray-300 transition-colors duration-300">
                                    Designed with growth in mind, allowing for seamless updates and new feature integrations as your business evolves.
                                </p>
                            </div>
                        </SpotlightCard>
                        ...
                        <SpotlightCard className="h-full bg-white/5 border-white/10 group hover:bg-white/10 transition-colors duration-300">
                            <div className="flex flex-col h-full p-6">
                                ...
                                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-purple-200 transition-colors duration-300">Cost-effective in the long run</h3>
                                <p className="text-gray-400 text-sm leading-relaxed grow group-hover:text-gray-300 transition-colors duration-300">
                                    Avoid recurring subscription fees of SaaS products and own your solution completely with no hidden costs.
                                </p>
                            </div>
                        </SpotlightCard>
                        ...
                        <SpotlightCard className="h-full bg-white/5 border-white/10 group hover:bg-white/10 transition-colors duration-300">
                            <div className="flex flex-col h-full p-6">
                                ...
                                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-purple-200 transition-colors duration-300">Secure & reliable</h3>
                                <p className="text-gray-400 text-sm leading-relaxed grow group-hover:text-gray-300 transition-colors duration-300">
                                    Implemented with top-tier security protocols specifically designed for your data protection and compliance needs.
                                </p>
                            </div>
                        </SpotlightCard>
                    </div>
                    ...
                    >
                        ...
                        <div className="mt-12">
                            <p className="text-gray-400 max-w-2xl mx-auto">
                                Transform manual, time-consuming processes into automated, efficient workflows. Watch your productivity soar and error rates drop.
                            </p>
                        </div>
                    </SpotlightCard>
                </div>
