  ...
  const positions = [
    {
      ...
      type: "Full-time",
      description:
        "Join our development team to build cutting-edge web applications using Next.js, React, and Node.js.",
      requirements: [
        "5+ years experience",
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Create beautiful, user-centric designs for web and mobile applications that delight our clients.",
      requirements: [
        "3+ years experience",
        "Figma proficiency",
        "Portfolio required",
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Manage social media campaigns across multiple platforms and drive engagement for our clients.",
      requirements: [
        "2+ years experience",
        "Platform expertise",
        "Creative mindset",
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Develop and execute SEO strategies to improve organic rankings and drive qualified traffic.",
      requirements: [
        "3+ years experience",
    ...
    },
    {
      ...
      type: "Contract",
      description:
        "Edit compelling video content for social media, commercials, and marketing campaigns.",
      requirements: [
        "2+ years experience",
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Develop comprehensive brand strategies and positioning for clients across various industries.",
      requirements: [
        "4+ years experience",
        "Strategic thinking",
        "Client management",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Continuous learning and career advancement in a fast-paced
                  environment.
                </p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Work on cutting-edge projects with top-tier clients and
                  technologies.
                </p>
              </div>
            </div>
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {position.requirements.map((req, i) => (
                          <span
                            key={i}
                            className="px-3 py-1 bg-white/5 text-gray-400 rounded-full text-xs"
                          >
                            {req}
                          </span>
                        ))}
