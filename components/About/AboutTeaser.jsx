  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative z-10">
        <SectionHeading eyebrow="Who We Are" title="Cosmic Coder 24" />
        ...
        >
          <p className="text-base sm:text-xl md:text-2xl text-gray-300 leading-relaxed mb-10 max-w-3xl">
            We are a team of creative professionals focused on building brands that stand out and grow in the digital space. Our expertise in website development, SEO, branding, and design helps businesses reach their full potential with clarity, visibility, and lasting impact.
          </p>
