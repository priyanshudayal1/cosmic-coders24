...
/* Magic Rings — https://www.reactbits.dev/animations/magic-rings
   Adapted from the reactbits source: marked as a client component for the App
   Router, and the container's stylesheet folded into Tailwind classes. */
