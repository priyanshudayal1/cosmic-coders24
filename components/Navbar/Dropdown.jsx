...
const Dropdown = ({ isOpen, items }) => {
    return (
        <div
            className={`absolute top-full left-0 min-w-[200px] bg-black/80 backdrop-blur-xl border border-white/10 rounded-xl overflow-hidden transition-all duration-300 ease-in-out transform origin-top shadow-2xl ${isOpen
