...
const Button = React.forwardRef(({ className, variant = "glass", size = "default", children, ...props }, ref) => {
    const variants = {
        glass: "bg-white/5 hover:bg-white/10 text-white border border-white/10 backdrop-blur-sm",
        primary: "bg-linear-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white shadow-lg shadow-purple-900/40",
